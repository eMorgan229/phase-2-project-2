...
## You must make a single page application (only one index.html file) using create-react-app.
     We are creating a "Tiny Gallery" App that allows the user to experience some of the art featured at the MET Art Museum and also be able to add their own artwork to the API.
## Your app should use at least 5 components in a way that keeps your code well organized.
    1. App
    2. Header
    3. Button
    4. Home (one of our 3 routes)
    5. Add (one of our 3 routes)
    6. Exhibitions (on of our 3 routes)
    7. Drop Down Meny
    8. Form
    9. Listing Container
    10. Gallery Cards
